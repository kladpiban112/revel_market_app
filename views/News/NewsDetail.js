                ...
                display_data.push(
                    <View>
                        ...
                        <View style={{ padding: 15, }}>
                            <Text style={[ styles.text_font, { fontSize: 20, color: '#F5F35B', }]}>
                                {this.state.news.news_title} <Text style={[ styles.text_font, { fontSize: 14, color: 'red', }]}>{this.state.news.news_date}</Text>
                            </Text>
                        </View>
